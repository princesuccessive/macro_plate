...
urlpatterns = [
    ...
    path('api/celery/', include('apps.celery.api.urls')),
    path('api/calendar/', include('apps.calendar.api.urls')),
    path('api/', include('apps.macroplate.api.urls')),
    path('', include('apps.macroplate.urls')),
...
if settings.TESTING or settings.DEBUG:
    ...
    for app_label, app_config in apps.app_configs.items():
        ...
        if app_config.api_urls:
            urlpatterns += [path(api_urls_path, include(app_config.api_urls))]
